  ...
  <div class="d-inline-block p-5">
    ...
    <form class="  d-inline-block mx-sm-auto pr-5 " >
      <div class="form-group" >
        <label for="formGroupExampleInput" class="input-label text-dark">check-in day:</label>
        <input type="date" class="form-control bg-transparent " id="formGroupExampleInput" >
      </div>
      <div class="form-group">
        <label for="formGroupExampleInput2" class="input-label text-dark">check-out day:</label>
      ...
      <div class="row">
          ...
          <div class="form-group col-3 text-center">
              <label for="infants" class="input-label">Infants</label>
              <select name="" id="infants" class="options p-1"> 
                  <option value="0">0</option>
                  <option value="0">1</option>
                  <option value="0">2</option>
                  <option value="0">3</option>
